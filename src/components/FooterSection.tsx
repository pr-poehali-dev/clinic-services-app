    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-background/70 leading-relaxed mb-6">
                УСЛУГИ УДОБСТВА — команда профессиональных клинеров с опытом более 5 лет. Мы используем только сертифицированную химию, которая безопасна для детей и домашних животных.
              </p>
      ...
      <footer className="py-8 px-6 md:px-16 border-t border-border">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="font-display text-xl font-light tracking-[0.2em]">УСЛУГИ УДОБСТВА</div>
          <div className="text-xs text-muted-foreground tracking-wide">© 2026 УСЛУГИ УДОБСТВА. Все права защищены.</div>
