...
const SERVICES = [
  ...
  { icon: "Armchair", title: "Разборка и сборка мебели", desc: "Аккуратно разберём и соберём любую мебель на новом месте", price: "от 500 ₽/час" },
  { icon: "Package", title: "Упаковка вещей", desc: "Упакуем хрупкие предметы и бытовую технику", price: "от 300 ₽/час" },
  { icon: "ArrowUpDown", title: "Подъём и спуск на любой этаж", desc: "Работаем с любой высотой, в том числе без лифта", price: "от 400 ₽/час" },
  { icon: "Trash2", title: "Вынос мусора", desc: "Уберём упаковочный материал и ненужные вещи после переезда", price: "от 200 ₽/выезд" },
];
