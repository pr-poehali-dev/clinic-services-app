...
const CLEANING_TYPES = ["Стандартная", "Генеральная", "После ремонта", "Офисная", "Химчистка", "Грузчики", "Разборка и сборка мебели", "Упаковка вещей", "Подъём и спуск на этаж", "Вынос мусора"];
